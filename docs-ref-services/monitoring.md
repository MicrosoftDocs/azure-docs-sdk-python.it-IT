...
## <a name="example---metrics"></a>Esempio - Metriche
Questo esempio ottiene le metriche relative a una risorsa in Azure (VM e così via). Questo esempio richiede almeno la versione 0.4.0 del pacchetto Python.
...
## <a name="example---alerts"></a>Esempio - Avvisi
...
> [Esplorare le API di gestione](/python/api/overview/azure/monitoring/management)
