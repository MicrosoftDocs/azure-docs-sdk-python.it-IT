...
Sono anche disponibili esempi di codice per la creazione di diversi tipi comuni di cluster HDInsight: [Esempi di HDInsight per Python](https://github.com/Azure-Samples/hdinsight-python-sdk-samples).
